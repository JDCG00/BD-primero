...
USE master;
DROP DATABASE camino_ignaciano;
GO
CREATE DATABASE camino_ignaciano
ON
( NAME = camino_ignaciano_dat,
    FILENAME = 'D:\Bases datos SQL Server\Camino_Ignaciano\camino_ignacianodat.mdf'
)
LOG ON
( NAME = camino_ignaciano_log,
    FILENAME = 'D:\Bases datos SQL Server\Camino_Ignaciano\camino_ignacianolog.ldf'    
);
GO
